...
import Lab5.BankAccounts.Credit;
import Lab5.BankAccounts.Debet;
...
public class Manager {
    ...
    //getters setters
        //date
    public static Date getDate(){ return today; }
    public void setDate( Date _today ){ this.today = _today; }
    public void setDate( String _today ){
        SimpleDateFormat format = new SimpleDateFormat("dd.MM.yyyy");
        try{
            this.today = format.parse( _today );
        }catch (Exception e ){
            e.printStackTrace();
        }
    }
    ...
    public void changeTime( String _date ){ this.setDate( _date); }
